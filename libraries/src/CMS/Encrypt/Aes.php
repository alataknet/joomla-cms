...
use Joomla\CMS\Encrypt\AesEncrypt;
use Joomla\CMS\Encrypt\AesEncrypt\Openssl;
...
class Aes
{
	 ...
	 * @param   string          $phpfunc  For testing
	 * @param   string          $priority Priority which adapter we should try first
	 */
	public function __construct($key, $strength = 128, $mode = 'cbc',  $phpfunc = null, $priority = 'openssl')
	{
		if ($priority == 'openssl')
		{
	 ...
	 * @return boolean
	 */
	public static function isSupported( $phpfunc = null)
	{
